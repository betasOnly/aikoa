/// Code snippet from https://pub.dev/packages/keyboard_avoider
/// But adds an additional padding of 40 since we overlay the toolbar above the
/// keyboard.
import 'dart:math';
...
class _KeyboardAvoiderState extends State<KeyboardAvoider> with WidgetsBindingObserver {
  ...
  void _resize() {
    ...
    final keyboardTop = screenSize.height - screenInsets.bottom - 40;
